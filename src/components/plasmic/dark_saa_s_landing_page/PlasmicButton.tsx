...
import sty from "./PlasmicButton.module.css"; // plasmic-import: rAcYS8s5mLjUI/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__qzX40)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___9MFlS)}
                role={"img"}
              />
            ),
