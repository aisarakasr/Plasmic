...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: uNGEa4X6K63Lt/css
    ...
    >
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__uu9M8)}
        >
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox___5Lglb)}>
              <PriceCard
                borders={["flatLeft"]}
                className={classNames("__wab_instance", sty.priceCard__dmQRj)}
              />
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__byh3G)}>
              <div className={classNames(projectcss.all, sty.freeBox__imTva)}>
                <div
              ...
              {(
                ...
                <PriceCard
                  borders={["flatCenter"]}
                  className={classNames("__wab_instance", sty.priceCard__gvfuR)}
                />
              ) : null}
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__tuPXv)}>
              <PriceCard
                borders={
                ...
                className={classNames("__wab_instance", sty.priceCard__faUdW)}
              />
            </div>
          ) : null}
        </p.Stack>
